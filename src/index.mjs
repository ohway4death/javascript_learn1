...
// const sayHello = (name='sato') => console.log(`こんにちは${name}さん`);
// sayHello();
 ...
 * mapやfilterを使った配列の処理
 */
// const nameArr = ["sato", "suzuki", "tanaka"];
